                  ...
                  <div class="col-lg-12 main-chart">
						...
						<?php
								...
								<div class='alert alert-warning'>
									...
									<span class='pull-right'><a href='index.php?page=barangview&stok=yes'>Cek Barang <i class='fa fa-angle-double-right'></i></a></span>
								</div>
								";	
							}
						?>
						...
						<a href="index.php?page=barangview&stok=yes" style="margin-right :0.5pc;" 
							class="btn btn-warning btn-md pull-right">
							<i class="fa fa-list"></i> Sortir Stok Kurang</a>
						<a href="index.php?page=barangview" style="margin-right :0.5pc;" 
							...
							<table class="table table-bordered table-striped" id="example1">
								...
								?>
									<tr>
										...
										<td>
											...
											<?php }else{?>
											<a href="index.php?page=barangview/details&barang=<?php echo $isi['id_barang'];?>"><button class="btn btn-primary btn-xs">Details</button></a>
										
											<a href="index.php?page=barangview/edit&barang=<?php echo $isi['id_barang'];?>"><button class="btn btn-warning btn-xs">Edit</button></a>
								...
								<tfoot>
									<tr>
										...
										<th colspan="2" style="background:#ddd">Keuntungan Rp.<?php echo number_format($totalUntung);?>,-</th>
									</tr>
								</tfoot>
							</table>
						</div>
									...
									<div class="modal-body">
										...
										<table class="table table-striped bordered">
											...
											<tr>
												...
												<td><input type="text" placeholder="kondisi Barang" required class="form-control" id="kondisi" name="kondisi"></td>
											</tr>
											<tr>
												<td>Harga Beli</td>
