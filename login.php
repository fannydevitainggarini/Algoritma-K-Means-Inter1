	...
	if(isset($_POST['proses'])){
		...
		if($jum > 0){
			...
			if($hasil['level']=="admin"){
				...
				echo '<script>alert("Login Sukses");window.location="login/index.php"</script>';	
			}else if($hasil['level']=="manager"){
				$_SESSION['level'] = "manager";
				echo '<script>alert("Login Sukses");window.location="index.php"</script>';	
			}else if($hasil['level']=="kasir"){
				$_SESSION['level'] = "kasir";
				echo '<script>alert("Login Sukses");window.location="index.php"</script>';	
			}
			else{
				echo '<script>alert("hey kamu siapa");history.go(-1);</script>';
			}
...
<html lang="en">
  <head>
    ...
    <title>Login Manajemen Kasir</title>
  ...
  <body style="background:#ffcc99;color:#fff;">
	  ...
	  <div id="login-page" style="padding-top:3pc;">
	  	<div class="container">
		      <form class="form-login" method="POST">
		        <h2 class="form-login-heading">Marthana Pratama</h2>
